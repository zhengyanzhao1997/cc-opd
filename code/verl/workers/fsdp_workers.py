...
class ActorRolloutRefWorker(Worker):
    ...
    def __init__(self, config: DictConfig, role: str):
        ...
        # TODO(upstream): support FSDP hybrid shard for larger model
    ...
    def _build_model_optimizer(
        ...
        # TODO(upstream): 1. support create from random initialized model. 2. Support init with FSDP directly
        ...
        with init_context(), warnings.catch_warnings():
            ...
            # some parameters may not in torch_dtype. TODO(upstream) remove this after we switch to fsdp2
        ...
        if self._is_rollout and self.config.rollout.name == "hf":
            # TODO(upstream) fix me. Current, auto_wrap_policy causes HFRollout to hang in Gemma
