...
# NOTE(upstream): add for verl. We can optimize it by making the dataloader yield List[int] without padding.
...
class vLLMRollout(BaseRollout):
    def __init__(self, model_path: str, config: DictConfig, tokenizer, model_hf_config, **kwargs):
        ...
        Args:
            ...
            **kwargs: optional vLLM engine arguments
        """
        super().__init__()
        self.config = config
    ...
    def generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        if self.lora_kwargs:
            ...
            if len(lora_int_ids) > 0:
                ...
                lora_requests = [LoRARequest(lora_name=f"{lora_int_id}", lora_int_id=lora_int_id, lora_path="/lora-placeholder")] * batch_size
        ...
        with self.update_sampling_params(**kwargs):
            ...
            # TODO(upstream): disable logprob when recompute_log_prob is enable
            ...
            if self.sampling_params.n > 1 and do_sample:
                ...
                # NOTE(upstream): for multi-turn https://github.com/volcengine/verl/pull/1037
        ...
        # TODO(upstream): fix position_ids on right_pad
