...
"""
Verify code correctness via an external sandbox-execution HTTP service.
The service URL is supplied at call time; this module makes no assumption
about the specific sandbox implementation beyond the request/response shape
defined in the functions below.
"""
